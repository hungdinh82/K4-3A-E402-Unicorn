...
const summaryHeadings = new Set(['TL;DR', 'KEY POINTS', 'DECISIONS', 'TENTATIVE DECISIONS', 'UNRESOLVED TOPICS', 'ACTION ITEMS', 'OPEN QUESTIONS', 'DEFERRED'])
